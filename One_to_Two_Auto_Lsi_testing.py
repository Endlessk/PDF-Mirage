...
if len(sys.argv) < 8 :
    print '\n==============================================='
    print 'ERROR! \nUsage:'
    print 'program.py folder_path PDF_1 targer_reviewer_ID_1 target_paper_ID_1 PDF_2 targer_reviewer_ID_2 target_paper_ID_2'
    print '===============================================\n'
    sys.exit(0)
...
for root, dirnames, filenames in os.walk(path):
    ...
    for filename in sorted(filenames):
		...
		stop_percentage1=0.5
		stop_percentage2=0.5
